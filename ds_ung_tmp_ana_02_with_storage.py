...
class UNGTemperatureAnalyzer:
    ...
    def plot_temperature_series_comparison(self):
        ...
        plt.legend()
        plt.tight_layout()
        output_path = os.path.join(self.config['output_dir'], 'ung_temperature_series_comparison.png')
    ...
    def plot_r_squared_comparison(self, r_squared_df):
        ...
        # Save plot
        output_path = os.path.join(self.config['output_dir'], 'ung_r_squared_comparison.png')
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        #plt.show()
    ...
    def plot_best_r_squared_relationship(self, df, best_feature, r_squared_value):
        ...
        output_path = os.path.join(
            ...
            f'ung_best_r_squared_relationship_{best_feature}.png'
        )
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        #plt.show()
    ...
    def plot_open_price_vs_temperature(self, df):
        ...
        output_path = os.path.join(self.config['output_dir'], 'ung_open_price_vs_temperature.png')
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        #plt.show()
    ...
    def plot_correlation_heatmap(self, df):
        ...
        # Save individual plot
        output_path = os.path.join(self.config['output_dir'], 'ung_correlation_heatmap.png')
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        #plt.show()
    ...
    def plot_price_vs_temp_anomaly_lag_correlation(self, df):
        ...
        output_path = os.path.join(self.config['output_dir'], 'ung_price_vs_temp_anomaly_lag_correlation.png')
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        #plt.show()
    ...
    def plot_temperature_anomaly_vs_price_changes(self, df):
        ...
        # Save individual plot
        output_path = os.path.join(self.config['output_dir'], 'ung_temperature_anomaly_vs_price_changes.png')
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        #plt.show()
    ...
    def plot_volume_vs_temperature_volatility(self, df):
        ...
        # Save individual plot
        output_path = os.path.join(self.config['output_dir'], 'ung_volume_vs_temperature_volatility.png')
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        #plt.show()
    ...
    def plot_storage_correlation_heatmap(self, df):
        ...
        plt.title('UNG Returns vs Storage Levels/Changes', fontsize=14, fontweight='bold')
        plt.xticks(rotation=45)
        plt.yticks(rotation=0)
        plt.tight_layout()
        output_path = os.path.join(self.config['output_dir'], 'ung_returns_vs_storage_correlation.png')
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        #plt.show()
    ...
    def save_results(self, df, r_squared_df, multivar_results, storage_significant):
        ...
        try:
            ...
            r_squared_file = os.path.join(output_dir, 'r_squared_results.csv')
            r_squared_df.to_csv(r_squared_file, index=False)
            logger.info(f"R-squared results saved to {r_squared_file}")

            if multivar_results:
                multivar_file = os.path.join(output_dir, 'multivariate_return_coefficients.csv')
            ...
            if storage_significant is not None:
                storage_file = os.path.join(output_dir, 'storage_return_correlations.csv')
